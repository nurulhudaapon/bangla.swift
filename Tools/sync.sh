...
SOURCE_FILES=(
    "Sources/BanglaKit/Transliteration/rules.json:packages/core/transliteration/assets/rules.json"
    "Tests/BanglaKitTests/test_data.json:packages/core/transliteration/tests/transliterate.test.json"
)
TEMP_DIR=".temp_sync"
